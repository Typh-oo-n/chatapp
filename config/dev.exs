...
config :chatapp, ChatappWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "QLFmifAo5u/w1zx1Gh4Rt0icPj/NxthJRRcDnRhTCbLpbrxCW0EWEKGOfiG8bhUq",
  watchers: [
...
config :chatapp, ChatappWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/chatapp_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :chatapp, dev_routes: true
